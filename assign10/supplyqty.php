...
$sql = "SELECT SNAME, STATUS, CITY FROM S WHERE S = '$_POST[supplier]';";
try {
...
$sql = "SELECT DISTINCT PNAME, QTY FROM P, SP WHERE P.P = SP.P AND SP.S = '$_POST[supplier]';";
try {
    $statement = $pdo->prepare($sql);
    $statement->execute();
    $rows = $statement->fetchAll(PDO::FETCH_ASSOC);
